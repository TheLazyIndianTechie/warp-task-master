...
> ℹ️ **This file contains the original README content from task-master-ai before the Warp-specific documentation cleanup.**

This file is preserved for reference only. The current [README.md](README.md) has been completely rewritten to focus on Warp-specific features and enhancements.

**For the current documentation, see:**
- [README.md](README.md) - Warp-focused documentation
- [Original task-master-ai project](https://github.com/eyaltoledano/claude-task-master) - Original project documentation

---

**Below is the archived original README content:**
